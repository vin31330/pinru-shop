    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <form data-order-form onSubmit={submit} noValidate className="mx-auto max-w-3xl px-4 py-7">
        ...
        <div className="mt-6 space-y-3">
          <button type="submit" disabled={items.length === 0 || checking || submitting || Boolean(validationError)} className="shopping-action-button w-full rounded-2xl bg-[#06C755] text-white disabled:opacity-50">
